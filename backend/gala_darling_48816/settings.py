"""
Django settings for gala_darling_48816 project.
...
ROOT_URLCONF = 'gala_darling_48816.urls'
...
WSGI_APPLICATION = 'gala_darling_48816.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Gala Darling Support <support@gala-darling-48816.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gala_darling_48816 API",
    "DESCRIPTION": "API documentation for gala_darling_48816 App",
    "VERSION": "v1",
}
